    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/jeefast?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                new PackageConfig()
                        //.setModuleName("User")
                       .setParent("com.example.demo.sys")// 自定义包路径
                ...
                new InjectionConfig() {
                    ...
                    public String outputFile(TableInfo tableInfo) {
                        return path+"/src/main/resources/mapper/auth/" + tableInfo.getEntityName() + "Mapper.xml";
                    }
                }))
        ).setTemplate(
